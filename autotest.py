...
class AutoTest():
    def __init__(self, results_dep):
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('29-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('30-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('31-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('1-1-2018', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 526
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('2-1-2018', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 526
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('3-1-2018', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        ...
        scrapedFlight.date_departure = datetime.strptime('29-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('4-1-2018', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        ...
        scrapedFlight.date_departure = datetime.strptime('30-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('29-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 538
        scrapedFlight.cheapest_duration = Time('16h2m')
        scrapedFlight.bestdeal_price = 607
        scrapedFlight.bestdeal_duration = Time('12h0m')
        everyReturnCombination.append(deepcopy(scrapedFlight))
        scrapedFlight.date_departure = datetime.strptime('30-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        ...
        scrapedFlight.date_departure = datetime.strptime('31-8-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('29-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 553
        ...
        scrapedFlight.date_departure = datetime.strptime('1-9-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('29-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 538
        ...
        scrapedFlight.date_departure = datetime.strptime('2-9-2017', '%d-%m-%Y')
        scrapedFlight.date_this_way = scrapedFlight.date_departure
        scrapedFlight.date_return = datetime.strptime('29-12-2017', '%d-%m-%Y')
        scrapedFlight.date_other_way = scrapedFlight.date_return
        scrapedFlight.cheapest_price = 538
